            ...
            >
              <div className="bg-slate-950/80 p-5 rounded-2xl border border-slate-700/60 text-center space-y-2">
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  For security reasons, worker PINs are managed directly by the Super Administrator (ADM-01). Please contact your Director to reset your counselor credentials.
                </p>
              </div>
              ...
              <Button
                ...
                className="w-full h-12 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-bold transition-all cursor-pointer"
              >
                Back to Login
              </Button>
            </motion.div>
