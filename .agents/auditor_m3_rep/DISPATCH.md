...
You are the Forensic Integrity Auditor (Replacement) for Milestone 3 (R3 Comprehensive Student Profile with Tabs).
Your working directory is: C:\Users\satya\Desktop\New folder\admin-portal\.agents\auditor_m3_rep
...
Write your handoff report to `C:\Users\satya\Desktop\New folder\admin-portal\.agents\auditor_m3_rep\handoff.md` and send a completion message to parent.
